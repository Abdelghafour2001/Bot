module.exports = {
  ...
  Token: process.env.Token || "MTAyNjIxMjMyMjYyNjI1MjkwMA.GdKGPJ.VzNBTWndU_0IYi2t8lt_yrRTjCqZw-XkoKN5Fs", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "1026212322626252900", // Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "11w_aybxOYvC_8ika9PZDT1_aCrxL-J2", // Discord Client Secret
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "42ca55511cc6462887b9774d6970c737", // Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "13ad9a6209c34981b9277859ed0736a6", // Spotify Client Secret
  },
};
